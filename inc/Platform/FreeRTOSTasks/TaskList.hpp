...
#include "TestServiceTask.hpp"
namespace TaskList {
    static UartDMATask uartDMATask = UartDMATask("XUartDMA", NULL, 10000, 500);
    ...
    static TestServiceTask testServiceTask = TestServiceTask("TestService", NULL, 3000);
