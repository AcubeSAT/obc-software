...
namespace CAN::Application {
    ...
    void sendBusSwitchoverMessage() {
        etl::vector<uint8_t, CAN::Message::MaxDataLength> data = {toggleBusSwitchover()};
    ...
    void sendUTCTimeMessage() {
        ...
        etl::vector<uint8_t, CAN::Message::MaxDataLength> data = {0, 0, static_cast<uint8_t>(msOfDay.count()),
