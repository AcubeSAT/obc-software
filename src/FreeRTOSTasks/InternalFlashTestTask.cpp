...
InternalFlashTestTask::testQuadWordWriteRead() {
    ...
    auto writeError = FlashDriver::writeQuadWord(writeData, testAddress);
    ...
    auto readError = FlashDriver::readFromMemory(readData,
...
FlashDriver::EFCError
InternalFlashTestTask::testPageWriteRead() {
    ...
    auto writeError = FlashDriver::writePage(writeData, testAddress);
    if (writeError != FlashDriver::EFCError::NONE) {
...
InternalFlashTestTask::testBoundaryConditions() {
    ...
    error = FlashDriver::writeQuadWord(testData, lastValidAddress);
    if (error == FlashDriver::EFCError::ADDRESS_UNSAFE) {
