...
1. Ensure you have downloaded the MCC standalone from the Microchip site.
...
**Note:** To close MCC, simply click on the 'x' in the corner. Never click on the red button in CLion, as it will interrupt the procedure and the script will stop without running the rest of the commands.
